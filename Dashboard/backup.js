$(document).ready(function() {
  ...
  function drawTable() {
    ...
    //Instantiate and draw the data table
  ...
  function drawBar() {
    ...
    data.addColumn('number', 'Avg Vids');
   ...
   * Word Cloud
   ...
   $( "#selectList" ).change(function() {
     ...
     $( "#selectList option:selected" ).each(function() {
       var selectedCategory = $("#selectList option:selected").text();
  ...
  */
  ...
  $( "#tableSelect" ).change(function() {
    selectTableData.length = 0; //clears selectTableData

    $( "#tableSelect option:selected" ).each(function() {
      var selectedCategory = $("#tableSelect option:selected").text();

      //table.clearChart(); //clears data in table chart

      if (selectedCategory == "All") {
        drawTable();
      } else {
        //function that take selected Category and display it
      }
    });
 }).trigger( "change" );


  //Adds Categories to Selection Lists
  for (var k=0; k < pieCategory.length; k++) {
    //Data Table Selection List
    $('#tableSelect').append($('<option>', {
      value: k,
      text: pieCategory[k]
    }));

    //Word Cloud Selection List
